...
int main(int argc, char* argv[])
{
    ...
    if(cpm_options.create)
    {
        ...
        if(cpm_options.create_mode!=1&&cpm_options.create_mode!=2&&cpm_options.create_mode!=3&&cpm_options.create_mode!=4&&cpm_options.create_mode!=5&&cpm_options.create_mode!=6&&cpm_options.create_mode!=7&&
